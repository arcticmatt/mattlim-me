...
[Pixsy](https://www.pixsy.com/) is a cool company, they help you find and fight image theft.
...
![morse-binary-tree](/images/blog/morse-binary-tree.png)
...
I just started using [CSS variables](https://developers.google.com/web/updates/2016/02/css-variables-why-should-you-care) in one of my projects, and they're pretty awesome. They're really simple to use, you just do something like this:
...
1. [Notion supports LaTeX now](https://twitter.com/NotionHQ/status/1270445764062228480)!
...
URL stands for Uniform Resource Locator. A URL identifies a _web_ resource and tells you its location (i.e. how to access it). For example, https://google.com is a URL, since it both identifies and locates a web resource.
...
- Eidetic memory: the ability to recall an image from memory with high precision for a _brief period after seeing it only once_. It's rare, but it exists.
...
Some other fun Nintendo facts can be found [here](https://www.vox.com/xpress/2014/8/7/5978739/nintendo-yoshisaur-munchakoopas-mario-homo-nintendonus).
...
_I found out about the [National Do Not Call Registry](https://en.wikipedia.org/wiki/National_Do_Not_Call_Registry) while reading about this stuff. Maybe I'll write about that later._
...
<video autoplay controls width="800" height="450">
...
_Effective Modern C++_ Item 1 has a good description of these rules.
...
One interesting thing that's been going on lately are the presidential primaries. I'm
not very educated about politics, so I've been watching some YouTube videos in my spare time.
...
Ok, done. There's some health/job/friend/travel/etc. stuff stuck between the
cracks there, but who has time to write about all that. Let's get to the
important part: what did I learn today?

Well, the other day, I learned that [Let Me Alone by Moow](https://www.youtube.com/watch?v=ffzUBzrW9HA)
heavily samples [These Days by Nico](https://www.youtube.com/watch?v=-nGLqXZ-f70).
Both songs are great by the way. I found out about the former song first, but
the latter song seems much more famous.
...
Yea, you can construct an enum with a value that isn't in the enumeration if you use list initialization! Kinda crazy right. You can read more about this [here](https://en.cppreference.com/w/cpp/language/enum).
...
A [_tenso_](https://en.wikipedia.org/wiki/Tenso) is a style of troubador song in which two (or maybe more) poets
debate about something. A tenso is usually written by two different poets,
but sometimes the second poet is imaginary. Here's an example by Maria de
Ventadorn. I can't find it online so I'll just copy it.

> Gui d'Ussel, because of you I'm quite distraught,
> for you've given up your song,
> and since I wish you'd take it up again,
> and since you know about such things,
> I'll ask you this: when a lady
> freely loves a man, should she do as much for him as he
> for her, according to the rules of courtly love?

> Lady Maria, _tensons_
> and all manner of song I thought I'd given up,
> but when you summon, how can I refuse to sing?
...
> and the lady should comply with his request
> within the bounds of common sense;
> and the lover ought to do her bidding
> as toward a friend and lady equally,
...
> her words and deeds should make it show;
> but if she's fickle or untrue
> she ought to hide it with a pretty face.

> Gui d'Ussel, suitors when they're new
> are not at all like that,
> for when they seek a lady's grace
> they get down on their knees, hands joined, and say:
> "Grant that I may freely serve you, lady,
> as your man," and she receives them;
> thus to me it's nothing short of treason
> if a man says he's her equal _and_ her servant.

> Lady, it's embarrassing
> to argue that a lady should
> be higher than the man with whom
> she's made one heart of two.
> Either you'll say (and this won't flatter you)
> that the man should love the lady more,
> or else you'll say that they're the same,
> because the lover doesn't owe her anything that doesn't bear
> love's name.
...
> treated _aesthetically_,... that is, in relation to good taste... When a
...
> very sad; but _we_ can't mend it. Therefore let us make the best of a bad
...
So much for updating daily. _Now_ I'll start doing that.
...
to get back to daily updates in March. I like the idea of recording _something_
...
Also, just a random note about Murakami that I'll put here. I read _Sputnik
Sweetheart_ while I was sick, and now I'm reading _Hard-Boiled_. I've read
_Norweigan Wood_, _Kafka on the Shore_, and _The Wind-up Bird Chronicle_ before.
...
For example, I was reading _Sputnik Sweetheart_. The plot, of course, involves
...
was worth a shot. And then _SPOILERS_ there's the ending. I don't remember the
ending to _Norweigan Wood_ that well but in my mind it's exactly the same.
Now, onto _Hard-Boiled_. The narrator is walking around a forest when he
...
For example, some people thought Proust's _In Search of Lost Time_ was a
roman à clef (from _How Proust Can Change Your Life_ by Alain de Botton, who
is great btw).

#### 02.07.17

_The Signal-Man_ is a supernatural short story by Charles Dickens. It tells the
...
Also read some stuff today about Christina of Markyate and sexual chastity (_The Sexuality
of Chastity_ by Karras). That book gives a pretty good description of Christina's
...
who try to grow it; in Mexico, where they call it _huitlacoche_, it's viewed
as a delicacy.
...
_House of Dolls_, a 1955 novella, coined this term. From Wikipedia:
...
> you have not observed - is known as the halo effect" (_Thinking, Fast and Slow_, 82).
...
If you play it, your IQ might drop by 15-25%. Here's a sample review:

> this game actually cured my depression and id love to thank the devs. thank you.
> my life has meaning again and ill continue to gift this to an insane amount of
...
I read _The Castle of Otranto_ today. It's a pretty interesting book that fails
...
> that of the thing meant, for example _suit_ for _business executive_, or the
> _track_ for _horse racing_.

<!-- -->

> "Is it really _her_ I love," I thought as I looked again at Chloe reading
...
made over $1,300,000 from prison. Also, Swizz Beatz is married to Alicia Keys.
Crazy!
...
VST stands for virtual studio technology. A VST is basically just a software synth.
It gets its name because it simulates "recording studio hardware" in software.
...
<img src="/images/blog/cookie-recipes.jpg" style="width: 300px;"/>
...
know that Katz's Deli has a super modern website and _ships_ their product
**nationwide**??? Probably not. [Check it](http://www.katzsdelicatessen.com/shipping.html).
You can get _sliced pastrami by the pound_ shipped from NY to your doorstep.
You can get _matzoh ball soup_ shipped from NY to your doorstep. What a
time to be alive.

#### 12.11.16

I feel like I learned some things while driving today, but I also feel like
I forgot all those things. I bought a _Midori_ brand notebook the other day
...
"Sleepwalking (Couples Only Dance Prom Night)" which appears on their _Interstate 8_
EP and their _Building Nothing Out of Something_ compilation album. I never thought
...
An interesting bit from Susan Sontag's _Regarding the Pain of Others_:
...
> plangent : adj. : _of a sound_ - loud, deep, and often sad.
...
Found my copy of _Reading the OED_ at home so now I can do this.
...
A profile of Leo Tolstoy that I copied from my copy of _War and Peace_ (Penguin,
Anthony Briggs):
...
> in 1852. He took part in the Crimean War, and the _Sebastopol Sketches_ that emerged from
...
> brought gave him the creative impulse for his two greatest novels, _War and Peace_
> (1869) and _Anna Karenina_ (1877). Later in life his views became increasingly radical
...
semi-famous because he won the sixth season of _Top Chef_. The head judge
of _Top Chef_ has said: "Out of all the cooks that have come through the show,
...
![image](/images/blog/ink_menu.png)
...
how famous this is) pops up in the poem [_Andreas_](<https://en.wikipedia.org/wiki/Andreas_(poem)>),
...
a thing. Bibliotherapy is, according to the _Online Dictionary for Library and
...
> blackamoor : noun : a dark-skinned person; _especially_ : black
...
The title of the African novel _Things Fall Apart_ is taken from the opening
lines of W.B. Yeat's poem ["The Second Coming"](https://www.poetryfoundation.org/poems-and-poets/poems/detail/43290):

> _Turning and turning in the widening gyre_ > _The falcon cannot hear the falconer;_ > _Things fall apart; the centre cannot hold;_ > _Mere anarchy is loosed upon the world..._
...
> _For whom is it well, for whom is it well?_ > _There is no one for whom it is well._

This stuff is on page 135 (in my version).

#### 11.05.16

Gustave Flaubert worked on a few books before the famous _Madame Bovary_.
Included amongst these was the first version of _The Temptation of Saint
Anthony_. He read the novel out loud to two friends over four days, and told
...
You should read some books slower than you think (Hume, _Things Fall Apart_).

#### 11.02.16

> bluestocking : noun (derogatory) : an intellectual or literary woman.

Found in _War and Peace_.
...
to clean specific areas. He named his product _Baby Gays_. He later changed
this to _Q-Tips Baby Gays_ (Q for quality), which then got shortened again to just
_Q-Tips_.
...
_Sic transit gloria mundi_ - thus passes the glory of the world. Another
...
Etymology of [nausea](https://www.youtube.com/watch?v=JidJV1ue1lI) (comes from the Greek work _naus_ for ship).
...
the _National Archives and Records Administration (NARA)_ conducted a study
...
The _Psychomachia_ is a poem by Prudentius written in the fifth century AD.
...
_Where the Wild Things Are_, once replied to a child's letter with
...
- _For Emma, Forever Ago_ was recorded at Justin's "little bungalow house in Eau Claire, Wisconsin."
...
The column rank of a matrix _A_ is the maximal number of linearly independent columns,
which is equivalent to the dimension of the column space of _A_ (space spanned
by the columns).
The row rank of a matrix _A_ is the maximal number of linearly independent rows,
which is equivalent to the dimension of the row space of _A_.
For any matrix _A_, the column rank and row rank are always equal.

#### 10.07.16

_Bon hiver_ is a French phrase meaning "good winter", from which the
...
- Stretch silk onto some kind of apparatus. One kind of apparatus involves
  rubber-banding a bunch of three-pronged forks around a wooden frame. The forks
  then pierce the silk, and are used to suspend the silk in the center of the
  frame. The shiny side should be facing upwards (this is the side you paint on).

- Apply gutta, which is a "resist." Basically, it's a gluelike substance that
  prevents dye from reaching the silk, and can be used to guide the dye into
  cool patterns.

- Let the gutta dry.

- Wet the entire shebang (with water). You can use a spray bottle, or run
  it under a shower, or otherwise cover the fabric with water.

- Get some paint brushes and dyes, and start painting. If you're using strong
  dyes, you might want to dilute them with water.

- Steam the thing. This binds the dye and the fabric together. I think you can
  repeat the entire process with the dried fabric, but I haven't actually tried
  it. Don't see a reason why you couldn't.

I think you can also wet it and then apply the gutta. It's not recommended but
it might do something cool (not sure, didn't try). You can also just skip
the gutta step entirely and just paint on some wet silk.
...
costs $3.60. Author's note: the ShackBurger is _delicious_.

#### 10.01.16

The coupon collector's problem goes as follows. There is a jar with _N_ unique
...
What is the probability that more than _T_ turns are needed to collect all
_N_ coupons? Upon analysis, it can be found that the expected number of turns _T_
is _O(n_ log*n)*. For example, if there are _N = 50_ coupons, it takes, on average,
_225_ turns to collect all the coupons.

#### 09.30.16

"Demosthenes, I know you by the pebble in your golden mouth!" - page 167 of
_War and Peace_. Demosthenes was a Greek orator who, according to legend, practiced
...
> The term _emoji character_ can be used for (b) where not clear from context.
...
and that no one is _anticipating_ the gun (and timing it just right so that
...
This results in some interesting sentences in the [Defect Levels Handbook](http://www.fda.gov/food/guidanceregulation/guidancedocumentsregulatoryinformation/sanitationtransportation/ucm056174.htm):
...
_La petite mort_, literally translated as "the little death," is an expression
...
"as is painting so is poetry." It occurs most famously in Horaces _Ars Poetica_,
...
Asian options are _exotic_. Ooh.
...
slight interest. Devil tumors are _transmissible_ tumors. They were first observed
...
There's this drink called _bai_. It's 5 calories, got antioxidants, and
...
Freud wrote a bunch of stuff about dreams (see _The Interpretation of Dreams_,
_On Dreams_). This work was focused towards helping his patients. That is,
...
Kafka never finished _The Castle_.
...
education." I came across this term in _Kafka on the Shore_, a book (quite good
...
The origin of this optimism? _Troilus and Criseyde_, a rollicking romance set
...
come to mind. This stuff was found in _Redcoat Resupply!_ by Major Tokar.
...
appears in Chaucer's _The Canterbury Tales_.
