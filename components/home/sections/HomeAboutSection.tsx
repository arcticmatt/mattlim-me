    ...
    <div className={containerStyles.container}>
      ...
      <div>
        <HomeParagraph>
          ...
          Previously, I worked on designing and implementing an IPC protocol for
          AR/VR devices. Although I prefer working on products—something I only
          really realized after doing systems software for a year—it was fun to
          work so close to the hardware. In addition to picking up cool new
          acronyms like “MCU” and “SoC,” I learned a lot about C++, TCP,
          FlatBuffers, and how painful it is to stand up a BlueTooth stack.
          Before that I worked on integrity, building tooling and infrastructure
          for the thousands of content moderators Facebook has around the world.
          My projects included building a system that maps decisions to actions
          (which is a lot more complicated than it sounds) and making{" "}
        ...
        <HomeParagraph>
          I graduated from Caltech in 2017, where I majored in Computer Science
          and minored in English. Most of my computer science sets are still on{" "}
          ...
          to me now. At least I can rest assured that I used to be able to write
          proofs. In 2016 I won{" "}
        ...
        <HomeParagraph>
          ...
          and one as a college freshman. Perhaps my proudest achievement is just{" "}
          <em>getting through</em> college while dealing with post-concussion
          syndrome. Over the years, I tried a lot of medications to get through
          it—Topiramate (the most effective for me), Verapamil, Amitriptyline,
          Innopran, Indomethacin, etc. I also went to quite a few different
          ...
          at Stanford in 2018 helped me finally overcome my symptoms. If you’re
          suffering, or have ever suffered, from brain problems, I highly
          ...
          . It gave me hope when it seemed like things would never improve—brain
          plasticity is an amazing thing.
        </HomeParagraph>
        <HomeParagraph>
          ...
          use Ableton Live, in case you’re curious. Occasionally I write things;
          my <Link href="https://pencilflip.medium.com/">Medium</Link> has more
          technical content, and I try to write a{" "}
          ...
          on my personal blog. Some of my other hobbies are bouldering, playing
          tennis, and playing games on my Nintendo Switch and Oculus Quest (Echo
          VR is awesome). I also read a lot—some of my favorite books are listed
          down below.
        </HomeParagraph>
      </div>
    </div>
